    ...
    const fetchWeatherData = async () => {
      ...
      if (data && !error) {
        if (periodFilter === 'atual') {
          ...
          setWeatherData(data[data.length - 1] || null);
          
          // Preparar dados históricos para o gráfico de temperatura
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div className="md:col-span-3 lg:col-span-3 bg-gray-800 rounded-lg p-3">
            ...
            <div className="h-32">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart 
                  data={periodFilter === 'historico' ? temperatureHistory : temperatureHistory.slice(-10)}
          ...
          <div className="bg-gray-800 rounded-lg p-3">
            ...
            <h3 className="text-sm font-medium mb-1">Previsão de Chuva</h3>
          ...
          <div className="bg-gray-800 rounded-lg p-3">
            ...
            <h3 className="text-sm font-medium mb-1">Pressão</h3>
